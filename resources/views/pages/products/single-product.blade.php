...
@section('f_content')
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="{{ route('product.cart') }}" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</a>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="text-left mb-5">
            <h2 class=" px-5"><span class="px-2">Similar Products</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col">
