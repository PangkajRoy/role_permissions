                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="phone" type="text" placeholder="+880 123456-7892">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Line 1</label>
                            <input class="form-control" name="address-1" type="text" placeholder="123 Street">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address Line 2</label>
                            <input class="form-control" name="address-2" type="text" placeholder="123 Street">
                        </div>                       
                        <div class="col-md-6 form-group">
                            <label>City</label>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="zip" type="text" placeholder="1234">
                        </div>
